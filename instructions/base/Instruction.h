...
namespace instructions::base {
    ...
    public:
        ...
        static const uint8_t dup_x2 = 0x5a;
        ...
        static const uint8_t ldiv = 0x6d;
        ...
        // Control
        static const uint8_t opcode_goto = 0xa7;
        ...
        static const uint8_t opcode_return = 0xb1;
        ...
        static const uint8_t opcode_new = 0xbb;
        ...
        // Reserved
        static const uint8_t breakpoint = 0xca;
        static const uint8_t impdep1 = 0xfe;
        static const uint8_t impdep2 = 0xff;

        virtual void fetchOperands(BytecodeReader&reader) = 0;
        virtual void execute(rtda::Frame&frame) = 0;
    };
